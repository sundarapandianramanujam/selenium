...
public class Dynamic_Webtable_covid {
			...
			for (int j = 0; j < args.length; j++) {
				if (j == indexofCountry) {
					if (allrowdata.get(j).getText().equalsIgnoreCase("India")) {
						...
						System.out.println(
								"value of Total Activecases in India :" + allrowdata.get(indexofActiveCases).getText());
						System.out.println(
						...
						System.out.println("value of Population in India :" + allrowdata.get(indexofPopulation).getText());
						System.out.println("----------------------------------");
					}
